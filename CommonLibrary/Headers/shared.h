...
enum COMMONLIBRARY_EXPORT CombatFightType
{
	FIGHT_THRUST,
	FIGHT_SWING,
	FIGHT_SMASH
...
enum COMMONLIBRARY_EXPORT CombatMoveType
{
	MOVE_CHARGE,
	MOVE_DODGE,
	MOVE_DUCK
...
enum COMMONLIBRARY_EXPORT CombatPhaseType
{
	PHASE_ENCOUNTER,
	PHASE_MELEE,
	PHASE_RESOLVE,
...
enum COMMONLIBRARY_EXPORT CombatShieldBlock
{
	SHIELD_THRUST,
	SHIELD_SWING,
	SHIELD_SMASH,
...
enum COMMONLIBRARY_EXPORT EquipmentType
{
	EQUIPMENT_ARMOR,
	EQUIPMENT_WEAPON
};

enum COMMONLIBRARY_EXPORT CombatActionType
{
	ACTION_DAMAGED,
	ACTION_WOUND,
	ACTION_MISS,
